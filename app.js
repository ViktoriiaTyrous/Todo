...
(function (arrOfTasks) {
  ...
  function listItemTemplate({ _id, title, body } = {}) {
    ...
    deliteBtn.classList.add("btn", "btn-danger", "ml-auto", "delete-btn");
    ...
    function onSubmitForm(e) {
      ...
      if (!inputTitleValue || !inputBodyValue) {
        alert("Заповніть будь ласка текстові поля Task і Body ")
      };

      const task = createNewTask(inputTitleValue, inputBodyValue);
      console.log(task)
